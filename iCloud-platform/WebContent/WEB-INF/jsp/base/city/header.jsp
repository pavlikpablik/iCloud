...
<div class="row-fluid">
	<div class="span10">
		<h4>
			省份城市信息管理 <small>您可以创建或者修改省份城市信息。</small>
		</h4>
		<!-- 列表页面显示的按钮 -->
		<div class="btn-toolbar list_bottoms">
			<div class="btn-group">
				<a class="btn  page_edit" href="city_edit.action"><i class="icon-pencil"></i>新建</a>
				<a class="btn " data-toggle="modal" href="#query"><i class="icon-search"></i>查询</a>
			</div>
			<!-- <div class="btn-group">
				<a class="btn  page_import" url="city_importFromExcel.action" ><i class="icon-upload"></i>导入</a>
				<a class="btn  page_export" url="city_export.action" ><i class="icon-download"></i>导出</a>
			</div> -->
		</div>
