...
<div class="modal-body">
	...
	<div id="importconfig" 
	     upload_url="socialBenefitBase_importfile.action;jsessionid=${cookie.JSESSIONID.value}"
	     file_types="*.xlsx" 
		...
		<div>
			<span id="spanButtonPlaceHolder"></span>
	         <a class="btn downexceltemp" href="socialBenefitBase_downloadTemplate.action">模板下载</a></span>
	</div>
	<div id="excelmessage">
