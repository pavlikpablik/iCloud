...
<c:if test="${method == 'create' }">
	...
	<AT:AuthorityTag actionName="socialBenefitBase_importfile.action">
		<button class="pageBarBtn listPageBarBtn pageImport"
			dialogTitle="导入社保类型" dialogWidth="650" dialogHeight="600"
			url="socialBenefitBase_importpre.action?method=create">导入</button>
	</AT:AuthorityTag>
	<AT:AuthorityTag actionName="socialBenefitBase_edit.action">
		<button class="pageBarBtn listPageBarBtn detailPageBarBtn"
			id="page-create" url="socialBenefitBase_edit.action" dialogWidth="1024"
...
<c:if test="${method == 'modify' }">
	...
	<AT:AuthorityTag actionName="socialBenefitBase_importfile.action">
		<button class="pageBarBtn listPageBarBtn pageImport"
			dialogTitle="导入社保类型" dialogWidth="650" dialogHeight="600"
			url="socialBenefitBase_importpre.action?method=modify">导入</button>
	</AT:AuthorityTag>
	<AT:AuthorityTag actionName="socialBenefitBase_export.action">
		<button class="pageBarBtn listPageBarBtn pageExport"
			url="socialBenefitBase_export.action">导出</button>
...
<c:if test="${method == 'audit' }">
	<button class="pageBarBtn listPageBarBtn" id="page-batchAudit"
		url="socialBenefitBase_batchAudit.action" dialogWidth="600"
