...
<div class="modal-body">
	<div id="uploadfileconfig" 
		     upload_url="socialBenefitBase_uploadFile.action;jsessionid=${cookie.JSESSIONID.value}?uploadOperate=upload" 
		     upload_init_url="socialBenefitBase_uploadFile.action?uploadOperate=init"
		     upload_delete_url="socialBenefitBase_uploadFile.action?uploadOperate=delete" 
		     download_url="socialBenefitBase_downloadUploadFile.action" 
