...
<%@ taglib prefix="s" uri="/struts-tags"%>
	...
	<script type="text/javascript">
		...
		$(function(){
			 	$.ajax({
					url : 'organ_queryAllTreeByBranchIdAndIds.action?orgId='+"${user.orgId}",
					cache : false,
					async : false,
					dataType : "json",
				...
				$.fn.zTree.init($("#treeOrgan"), setting, zNodes);
				$.fn.zTree.getZTreeObj("treeOrgan").expandAll(true);
...
<div class="modal-footer">
	<a href="#" class="btn btn-primary" data-dismiss="modal" id="page_organ_save">保存</a> 
