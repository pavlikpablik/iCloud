 ...
 * Version 2.0 (the "License"); $Id: Struts2Utils.java,v 1.1 2010/07/15 01:29:09
 * alan Exp $
 */
...
public class Struts2Utils
{
   ...
   public static void renderJson( final Map map,final String[] ignores, final String... headers )
   {
   ...
   /**
    * 直接输出JSON并且过滤不需要转的字段（只对单个对象过滤字段有效，对list，map，set等过滤无效）
    * 
    * @param object Java对象,将被转化为json字符串.
    * @see #render(String, String, String...)
    */
   public static void renderJsonFilter( final Object object,final String[] filters, final String... headers )
   {
	   List<String> ignoreList = new ArrayList<String>();
   	   if (filters!=null && filters.length>0) {
   		   ignoreList = Arrays.asList(filters);
   	   }
   	   renderJsonFilter(object, ignoreList, headers);
   }
    ...
    * @see #render(String, String, String...)
    */
   public static void renderJsonFilter( final Object object,final List<String> ignoreList, final String... headers )
   {
